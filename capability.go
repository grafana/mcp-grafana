...
// parseAPIDiscoveryResponse parses an HTTP response from the /apis endpoint
// into a capabilityCacheEntry. This is shared by both the test-facing DiscoverAPIs
// and the production GrafanaInstance.discoverAPIsAuthenticated.
func parseAPIDiscoveryResponse(resp *http.Response) (*capabilityCacheEntry, error) {
...
func DiscoverAPIs(ctx context.Context, httpClient *http.Client, baseURL string) (*capabilityCacheEntry, error) {
	...
	return parseAPIDiscoveryResponse(resp)
}
