...
echo ""
echo "This will:"
echo "  ✓ Start Keycloak (port 8082) and Grafana (port 3000)"
...
echo "  curl -s \"http://localhost:3000/api/user\" \\"
...
echo "================================================"
echo ""
echo "OAuth2 Setup Guide:         docs/oauth2-auth-proxy-setup.md"
echo "Testdata Notes:             testdata/README_OAUTH2_TESTING.md"
echo ""
