...
- `agento11y_evals_write` (upsert, delete, fork, and test evaluators; create, update, delete, and preview eval rules and guards; save and delete saved conversations, create/update/delete collections, and add/remove collection members; update and cancel experiments; create and update test suites, create and publish versions, and upsert and delete test cases)
