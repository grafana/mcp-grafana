...
The following table lists MCP tools, required RBAC permissions, and typical scopes. Categories marked with `*` are off until you add them to `--enabled-tools` (refer to [Command-line flags](../../configure/command-line-flags/)).
...
| `tempo_traceql-search`            | Tempo          | Search for traces using TraceQL queries                                                                      | `datasources:query`                                    | `datasources:uid:tempo-uid`                         |
| `tempo_traceql-metrics-instant`   | Tempo          | Compute a single metric value from trace data                                                                | `datasources:query`                                    | `datasources:uid:tempo-uid`                         |
| `tempo_traceql-metrics-range`     | Tempo          | Compute a metric time series from trace data                                                                 | `datasources:query`                                    | `datasources:uid:tempo-uid`                         |
| `tempo_get-trace`                 | Tempo          | Fetch a complete trace by ID                                                                                 | `datasources:query`                                    | `datasources:uid:tempo-uid`                         |
| `tempo_trace-diff`                | Tempo          | Compare two traces                                                                                           | `datasources:query`                                    | `datasources:uid:tempo-uid`                         |
| `tempo_get-attribute-names`       | Tempo          | List available trace attribute names                                                                         | `datasources:query`                                    | `datasources:uid:tempo-uid`                         |
| `tempo_get-attribute-values`      | Tempo          | Get values for a specific trace attribute                                                                    | `datasources:query`                                    | `datasources:uid:tempo-uid`                         |
