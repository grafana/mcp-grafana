...
func AddDatasourceTools(s *mcp.Server, enableWriteTools bool) {
	ListDatasources.Register(s)
	GetDatasource.Register(s)
	CheckDatasourcesHealth.Register(s)
	if enableWriteTools {
		CreateDatasource.Register(s)
		UpdateDatasource.Register(s)
	}
}
