...
func AddGraphiteTools(s *mcp.Server, enableQueryTools bool) {
	ListGraphiteMetrics.Register(s)
	ListGraphiteTags.Register(s)
	if enableQueryTools {
		QueryGraphite.Register(s)
		QueryGraphiteDensity.Register(s)
	}
}
