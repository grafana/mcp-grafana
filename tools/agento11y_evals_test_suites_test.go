...
func TestAgento11yManageTestSuitesRead(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			params: Agento11yEvalsReadParams{Operation: "list_suites"},
		...
		},
		{
			...
			params: Agento11yEvalsReadParams{Operation: "list_suites", Limit: 10, Cursor: "42"},
			handler: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
		...
		},
		{
			...
			params: Agento11yEvalsReadParams{Operation: "get_suite", SuiteID: "suite/1 2"},
			handler: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
				require.Equal(t, http.MethodGet, r.Method)
		...
		},
		{
			...
			params: Agento11yEvalsReadParams{Operation: "list_test_cases", SuiteID: "suite-1", Version: "v2", Limit: 5},
			handler: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
		...
		},
		{
			...
			params: Agento11yEvalsReadParams{Operation: "get_test_case", SuiteID: "suite/1", Version: "v 2", TestCaseID: "case/3"},
			handler: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
		...
		},
		{
			...
			params:  Agento11yEvalsReadParams{Operation: "create_suite"},
			wantErr: `unknown operation "create_suite", must be one of: ` + agento11yEvalsReadOperations,
		},
		{
...
func TestAgento11yManageTestSuitesReadWrite(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			params:  Agento11yEvalsWriteParams{Operation: "get_suite", SuiteID: "suite-1"},
			wantErr: `"get_suite" is an agento11y_evals_read operation, not agento11y_evals_write`,
		},
		{
			name:   "create_suite sends only the fields the route declares",
			params: Agento11yEvalsWriteParams{Operation: "create_suite", Name: &name, Tags: &tags},
			handler: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
		...
		},
		{
			...
			params: Agento11yEvalsWriteParams{Operation: "create_suite", SuiteID: "suite-1", Name: &name, Description: &description},
			handler: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
				body := decodeRequestBody(t, r)
		...
		},
		{
			...
			params: Agento11yEvalsWriteParams{Operation: "update_suite", SuiteID: "suite-1", Name: &name},
			handler: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
				body := decodeRequestBody(t, r)
				assert.Equal(t, "triage regression", body["name"])
				assert.NotContains(t, body, "description")
		...
		},
		{
			...
			params: Agento11yEvalsWriteParams{Operation: "update_suite", SuiteID: "suite-1", Description: &emptyDescription, Tags: &noTags},
			handler: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
		...
		},
		{
			...
			params: Agento11yEvalsWriteParams{Operation: "create_draft_version", SuiteID: "suite-1", Changelog: "add a regression case"},
			handler: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
				require.Equal(t, http.MethodPost, r.Method)
		...
		},
		{
			...
			params: Agento11yEvalsWriteParams{Operation: "create_draft_version", SuiteID: "suite-1", EmptyDraft: true},
			handler: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
				body := decodeRequestBody(t, r)
		...
		},
		{
			...
			params: Agento11yEvalsWriteParams{Operation: "publish_version", SuiteID: "suite/1", Version: "v 3"},
			handler: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
				require.Equal(t, http.MethodPost, r.Method)
		...
		},
		{
			...
			params: Agento11yEvalsWriteParams{Operation: "publish_version", SuiteID: "suite-1", Version: "v1"},
			handler: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
		...
		},
		{
			...
			params: Agento11yEvalsWriteParams{Operation: "upsert_test_case", SuiteID: "suite-1", Version: "v1", Input: map[string]any{"question": "?"}},
			handler: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
				w.WriteHeader(http.StatusConflict)
		...
		},
		{
			...
			params: Agento11yEvalsWriteParams{Operation: "delete_test_case", SuiteID: "suite-1", Version: "v3", TestCaseID: "case-3"},
			handler: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
		...
		},
		{
			...
			params:  Agento11yEvalsWriteParams{Operation: "upsert_test_case", SuiteID: "suite-1", Version: "v3", Input: map[string]any{}},
			wantErr: "input is required and must not be empty for 'upsert_test_case' operation",
		},
		{
			name:    "delete_test_case requires a test case id",
			params:  Agento11yEvalsWriteParams{Operation: "delete_test_case", SuiteID: "suite-1", Version: "v3"},
		...
		},
		{
			...
			params:  Agento11yEvalsWriteParams{Operation: "delete_suite"},
			wantErr: `unknown operation "delete_suite", must be one of: ` + agento11yEvalsWriteOperations,
		},
		{
			name:    "reading one version on its own is not an operation on the write variant either",
			params:  Agento11yEvalsWriteParams{Operation: "get_version", SuiteID: "suite-1", Version: "v2"},
			wantErr: `unknown operation "get_version"`,
		},
		{
			// Under the split, agento11y_evals_write has no filter fields for
			// reads at all (Tags/Name/Input here are write-only test-suite
			// fields), so a read operation is rejected as belonging to the
			// sibling tool rather than field-validated or accepted with its
			// write-only fields silently dropped.
			name:    "list_suites, get_suite, and list_test_cases are rejected as sibling read operations",
			params:  Agento11yEvalsWriteParams{Operation: "list_suites", Tags: &tags},
			wantErr: `"list_suites" is an agento11y_evals_read operation, not agento11y_evals_write`,
		},
		{
			...
			params:  Agento11yEvalsWriteParams{Operation: "create_suite", Name: &name, Input: map[string]any{"question": "?"}},
		...
		},
		{
			...
			params:  Agento11yEvalsWriteParams{Operation: "create_suite", Name: &name, Changelog: "first cut"},
		...
		},
		{
			...
			params:  Agento11yEvalsWriteParams{Operation: "create_suite", Name: &name, Version: "v1"},
		...
		},
		{
			...
			params:  Agento11yEvalsWriteParams{Operation: "create_draft_version", SuiteID: "suite-1", Expected: map[string]any{"answer": "ok"}},
		...
		},
		{
			...
			params:  Agento11yEvalsWriteParams{Operation: "create_draft_version", SuiteID: "suite-1", Name: &name},
		...
		},
		{
			...
			params:  Agento11yEvalsWriteParams{Operation: "create_draft_version", SuiteID: "suite-1", TestCaseID: "case-3"},
		...
		},
		{
			...
			params:  Agento11yEvalsWriteParams{Operation: "update_suite", SuiteID: "suite-1", Name: &name, Category: "routing"},
		...
		},
		{
			...
			params:  Agento11yEvalsWriteParams{Operation: "publish_version", SuiteID: "suite-1", Version: "v3", Input: map[string]any{"question": "?"}},
		...
		},
		{
			...
			params:  Agento11yEvalsWriteParams{Operation: "upsert_test_case", SuiteID: "suite-1", Version: "v3", Input: map[string]any{"question": "?"}, Changelog: "add a case"},
		...
		},
		{
			...
			params:  Agento11yEvalsWriteParams{Operation: "delete_test_case", SuiteID: "suite-1", Version: "v3", TestCaseID: "case-3", EmptyDraft: true},
...
func TestAgento11yTestSuiteRoutesAvoidTheStandaloneVersion(t *testing.T) {
	...
	checkPath := func(t *testing.T, dispatch func(ctx context.Context) (any, error)) {
		t.Helper()
	...
	for _, params := range []Agento11yEvalsReadParams{
		...
		t.Run(params.Operation, func(t *testing.T) {
			checkPath(t, func(ctx context.Context) (any, error) { return agento11yEvalsRead(ctx, params) })
		})
	}
	...
	for _, params := range []Agento11yEvalsWriteParams{
		...
		t.Run(params.Operation, func(t *testing.T) {
			checkPath(t, func(ctx context.Context) (any, error) { return agento11yEvalsWrite(ctx, params) })
		})
	}
}

// TestAgento11yEvalsTestSuiteGuidance pins the test-suite-specific parts of
// agento11y_evals_read/_write's merged description that no request test
// touches: the two rules a caller cannot discover from a successful response.
// The tool-wide annotations and disjoint operations are covered once for all
// five sub-domains by TestAgento11yEvalsSplitOperationsAreDisjoint in
// agento11y_evals_test.go, not repeated here.
func TestAgento11yEvalsTestSuiteGuidance(t *testing.T) {
	for _, guidance := range []string{
		...
		assert.Contains(t, Agento11yEvalsWrite.Tool.Description, guidance)
	}

	// A published version rejects every edit, so a caller has to know before it
	// builds one. Unlike the pre-consolidation single-name dual-schema tool,
	// this domain knowledge and the data:read permission it needs now live
	// only on the read side; the write tool has no read operations to explain
	// them for.
	assert.Contains(t, Agento11yEvalsRead.Tool.Description, "publishing freezes it")
	assert.Contains(t, Agento11yEvalsRead.Tool.Description, "grafana-agento11y-app.data:read")
}
