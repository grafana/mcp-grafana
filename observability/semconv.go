...
// MetricNamesHistogramView enables native histograms for metric-name discovery.
// Embedders should install this view on the provider supplied in GrafanaConfig.
func MetricNamesHistogramView() sdkmetric.View {
	return sdkmetric.NewView(
		sdkmetric.Instrument{Name: "mcp.metric_names.*", Kind: sdkmetric.InstrumentKindHistogram},
