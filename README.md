...
| `create_snapshot`                 | Snapshot                  | Create a dashboard snapshot from a full dashboard payload                                                    | `dashboards:read`                                      | `dashboards:*` or `dashboards:uid:abc123`           |
| `delete_snapshot`                 | Snapshot                  | Delete a dashboard snapshot by snapshot key                                                                  | `dashboards:read`                                      | `dashboards:*` or `dashboards:uid:abc123`           |
