...
> **Note:** Agent Observability tools are **disabled by default**. To enable them, add `agento11y` to your `--enabled-tools` flag. They require the Grafana Agent Observability app to be installed on the Grafana instance.
