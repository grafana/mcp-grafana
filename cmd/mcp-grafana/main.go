...
var categoryDescription = map[string]string{
	...
	"agento11y":     "Agent Observability: Search and inspect LLM conversations, generations, and evaluation scores from Grafana Agent Observability, and read or manage its eval configuration (evaluators, templates, eval rules, and guards).",
