...
type disabledTools struct {
	...
	dashboard, oncall, asserts, sift, teams bool
}
...
func (dt *disabledTools) addFlags() {
	flag.StringVar(&dt.enabledTools, "enabled-tools", "search,datasource,incident,prometheus,loki,alerting,dashboard,oncall,asserts,sift,teams", "A comma separated list of tools enabled for this server. Can be overwritten entirely or by disabling specific components, e.g. --disable-search.")
	...
	flag.BoolVar(&dt.teams, "disable-teams", false, "Disable teams tools")
}
...
func (dt *disabledTools) addTools(s *server.MCPServer) {
	...
	maybeAddTools(s, tools.AddTeamsTools, enabledTools, dt.teams, "teams")
}
